...
export class MarketService {
  ...
  private coinmarketCapURLSTM = 'https://api.coinmarketcap.com/v1/ticker/bitcoin/?convert=';
  ...
  getCoinInfo() {
    ...
    this.http.get(this.coinmarketCapURLSTM + this.fiatCurrency, options).subscribe(result => {
      ...
      if (coinInfo) {
        this.coinMarketInfo = {
          ...
          rank: coinInfo.rank,
          //TO-DO
          price_fiat: coinInfo['price_' + this.fiatCurrency.toLowerCase()] * 0.00002,
